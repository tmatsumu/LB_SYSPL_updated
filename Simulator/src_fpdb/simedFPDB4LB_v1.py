...
def write_db(filenameout,x0,y0,polang0,x1,y1,polang1,x2,y2,polang2,x3,y3,polang3,x4,y4,polang4):
    ...
    for i in range(0,num_tot):
        list_entries = ( 2*i, k+1, x[i]/radeg, y[i]/radeg, polang[2*i]/radeg, wafer[j], wafer[j]+'_'+str(k+1)+'t', 't' )
        c.execute('insert into detector values (?,?,?,?,?,?,?,?)',list_entries)
        
        list_entries = ( 2*i+1, k+1, x[i]/radeg, y[i]/radeg, polang[2*i+1]/radeg, wafer[j], wafer[j]+'_'+str(k+1)+'b', 'b')
        c.execute('insert into detector values (?,?,?,?,?,?,?,?)',list_entries)
...
#        write_txt_tmp('FPDB4sim_simfullfpdb_skyview.txt',x0,y0,polang0,x1,y1,polang1,x2,y2,polang2,x3,y3,polang3,x4,y4,polang4,x5,y5,polang5,x6,y6,polang6)
        ...
        write_txt_tmp(filenameout+'.txt',x0,y0,polang0,x1,y1,polang1,x2,y2,polang2,x3,y3,polang3,x4,y4,polang4)
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if q_plot:
        ...
        ax.plot(x0, y0,'.y')
        ax.plot(x0[0],y0[0],'hb')
        ax.plot(x0[1],y0[1],'hb')
        ax.plot(polvec_x0_t,polvec_y0_t,'r')
        ax.plot(polvec_x0_b,polvec_y0_b,'b')
    
        ax.plot(x1, y1,'.m')
        ax.plot(x1[0],y1[0],'hb')
        ax.plot(x1[1],y1[1],'hb')
        ax.plot(polvec_x1_t,polvec_y1_t,'r')
        ax.plot(polvec_x1_b,polvec_y1_b,'b')
        
        ax.plot(x2, y2,'.r')
        ax.plot(x2[0],y2[0],'hb')
        ax.plot(x2[1],y2[1],'hb')
        ax.plot(polvec_x2_t,polvec_y2_t,'r')
        ax.plot(polvec_x2_b,polvec_y2_b,'b')    
        
        ax.plot(x3, y3,'.g')
        ax.plot(x3[0],y3[0],'hb')
        ax.plot(x3[1],y3[1],'hb')
        ax.plot(polvec_x3_t,polvec_y3_t,'r')
        ax.plot(polvec_x3_b,polvec_y3_b,'b')
        
        ax.plot(x4, y4,'.k')
        ax.plot(x4[0],y4[0],'hb')
        ax.plot(x4[1],y4[1],'hb')
        ax.plot(polvec_x4_t,polvec_y4_t,'r')
        ax.plot(polvec_x4_b,polvec_y4_b,'b')
        
#        ax.plot(x5, y5,'.c')
#        ax.plot(x5[0],y5[0],'hb')
#        ax.plot(x5[1],y5[1],'hb')
#        ax.plot(polvec_x5_t,polvec_y5_t,'r')
#        ax.plot(polvec_x5_b,polvec_y5_b,'b')
#        
#        ax.plot(x6, y6,'.b')
#        ax.plot(x6[0],y6[0],'hb')
#        ax.plot(x6[1],y6[1],'hb')
#        ax.plot(polvec_x6_t,polvec_y6_t,'r')
#        ax.plot(polvec_x6_b,polvec_y6_b,'b')
