...
dir_db  = '/home/cmb/tmatsumu/LB_SYSPL/LB_SYSPL_v4.3/pyScans/dataout/'
sub_dir = 'LB_L2_20160919_Wallis_LargeLissajous_samplerate_SCANSPEC_1440min_38.0degs_93.0min_57.0degs_0.1rpm_365day_nside256_10Hz/ptg/'
filename_db = 'LBPTG_latlon_eclip.db'
sq_command = 'select * from LBSimPtg where id < 2'

filename_out = 'test'

DB_arr= read_lb_observation(dir_db+'/'+sub_dir+'/'+filename_db, sq_command)
