...
for i in range(0,ydays):
    ...
    mapout = liblb.gen_scan_c_mod_moon(theta_antisun, theta_boresight, freq_antisun, freq_boresight, total_time, today_julian, sample_rate, dir_out, filename, title, nside, runtime_i, option_gen_ptg)
