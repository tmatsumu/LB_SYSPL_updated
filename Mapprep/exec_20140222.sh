...
if [[ ${band_name}GHz = "60GHz" ]];then
    ...
    beam_arcmin=75
    band=band10
    dir=/group/cmb/litebird/simdata/Maps/20131001_linux_711_LSM/000uK/lensed/r00001/k10/0051-0100/PSM_OUTPUT/skyinbands/PSM_IDEAL/${band}/
fi
...
if [[ ${band_name}GHz = "140GHz" ]];then
    ...
    beam_arcmin=32
    band=band40
    dir=/group/cmb/litebird/simdata/Maps/20131001_linux_711_LSM/000uK/lensed/r00001/k10/0101-0150/PSM_OUTPUT/skyinbands/PSM_IDEAL/${band}/
fi
...
if [[ ${band_name}GHz = "195GHz" ]];then
    ...
    beam_arcmin=23
    band=band45
    dir=/group/cmb/litebird/simdata/Maps/20131001_linux_711_LSM/000uK/lensed/r00001/k10/0151-0200/PSM_OUTPUT/skyinbands/PSM_IDEAL/${band}/
fi
...
if [[ ${band_name}GHz = "280GHz" ]];then
    ...
    beam_arcmin=16
    band=band30
    dir=/group/cmb/litebird/simdata/Maps/20131001_linux_711_LSM/000uK/lensed/r00001/k10/0251-0300/PSM_OUTPUT/skyinbands/PSM_IDEAL/${band}/
fi

dir_out=/group/cmb/litebird/simdata/Maps/20131001_linux_711_LSM/processed_maps/${band_name}GHz/${unit}
mkdir -p $dir_out
